...
set.seed(123)
boruta.train <- Boruta(`blood sugar`~.-id, data = local_data, doTrace = 2)
print(boruta.train)
#Boruta对变量数据集中的意义给出了明确的命令。
#29 attributes confirmed important: `*Alanine aminotransferase`, `*Aspartate aminotransferase`,
#`*globulin`, `*r-glutamyl converting enzyme`, `*Total protein` and 24 more;
#3 attributes confirmed unimportant: `*Alkaline phosphatase`, `Basophil%`, `Monocytes%`;
#2 tentative attributes left: `Eosinophil%`, `PlateletVolume distribution Width`;
#
